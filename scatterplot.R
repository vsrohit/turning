...
mp2 <- ggplot(data = summary_data) +
  geom_point(mapping = aes(x = s, y = Mean, shape = f, size = d, color = Round))
...
sd2 <- ggplot(data = summary_data) +
  geom_point(mapping = aes(x = s, y = Std.dev, shape = f, size = d, color = Round))
...
sk1 <- ggplot(data = summary_data) +
  geom_point(mapping = aes(x = f, y = Skewness, shape = s, size = d, color = Round))
save_plot("skewness vs feed.pdf",sk1,
          base_height = 4, base_width = 5)

#skew_plot2
sk2 <- ggplot(data = summary_data) +
  geom_point(mapping = aes(x = s, y = Skewness, shape = f, size = d, color = Round))
...
k1 <- ggplot(data = summary_data) +
  geom_point(mapping = aes(x = f, y = Kurtosis, shape = s, size = d, color = Round))
save_plot("Kurtosis vs feed.pdf",k1,
          base_height = 4, base_width = 5)
#ks_plot2
k2 <- ggplot(data = summary_data) +
  geom_point(mapping = aes(x = s, y = Kurtosis, shape = f, size = d, color = Round))
...
mt2 <- ggplot(data = summary_data) +
  geom_point(mapping = aes(x = s, y = Mean_trend, shape = f, size = d, color = Round))
...
#sd_trend1
sd1 <- ggplot(data = summary_data) +
  geom_point(mapping = aes(x = f, y = Std.dev_trend, shape = s, size = d, color = Round))
save_plot("sd trend vs feed.pdf",sd1,
          base_height = 4, base_width = 5)

#sd_trend2
sd2 <- ggplot(data = summary_data) +
  geom_point(mapping = aes(x = s, y = Std.dev_trend, shape = f, size = d, color = Round))
